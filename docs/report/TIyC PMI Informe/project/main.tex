...
\begin{document}
    ...
    \input{../chapters/definicion_hamming.tex}
    \input{../chapters/definicion_huffman.tex}
    \input{../chapters/programacion.tex}
    \input{../chapters/manual_usuario.tex}
    \input{../chapters/problemas.tex}
