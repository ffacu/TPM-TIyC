...
Las pantallas de Huffman y Hamming ofrecen una muestra estadística, debajo del nombre de los archivos, donde se pueden ver y comparar los tamaños y pesos de los archivos: el original, el compactado y el descompactado. Esto permite evaluar la eficiencia real de la compresión.
